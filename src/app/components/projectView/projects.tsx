    ...
    return (
        <div className={styles.container}>
            ...
            <ul className={styles.projectContainer}>
                ...
                <ProjectCard name="Museo Semilla App" pText="Developed an iOS app to streamline museum tour guide tasks and enhance accounting, quality check, and service management processes. Created a progressive web app for client tours. Used Swift for iOS development and Django for backend. Led Software Requirements Specifications and team management. Designed iOS app interfaces, implemented app security, and conducted testing. Utilized Agile SCRUM methodology and Git for version control. " pImage="Museo.png" lText="See App Demo" lLink="https://www.youtube.com/watch?v=RFc8qAZJZ8s" lName="MuseoSemilla"/>
                </ul></li>
